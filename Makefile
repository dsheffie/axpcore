...
OBJ = top.o verilated.o verilated_fst_c.o loadelf.o interpret.o alpha_interp.o disassemble.o helper.o saveState.o syscall.o temu_code.o

SV_SRC = core_l1d_l1i.sv core.sv exec.sv decode_alpha.sv alpha_zapper.sv shiftregbit.sv shift_right.sv mul.sv find_first_set.sv l1d.sv machine.vh predecode.sv rob.vh uop.vh ram1r1w.sv ram2r1w.sv popcount.sv count_leading_zeros.sv fair_sched.sv csa.sv rf6r3w.sv reg_ram1rw.sv perfect_l1d.sv perfect_l1i.sv l2.sv l2_2way.sv mwidth_add.sv addsub.sv tlb.sv mmu.sv l1i_2way.sv nu_l1d.sv compute_pht_idx.sv clz64.sv ctz64.sv
